...
| **L4** | Tour report modal + four-bar panel UI | M | L3 | **new** `src/ui/render/modals/tour.rs`, `src/ui/render/panels.rs`, `src/ui/input/main.rs`, `mod`/`pub use` lines in `ui/render/modals/mod.rs` | 🔒 claimed | sonnet-l4 | life/v0.6 | |
